...
function listar_tramite(){
  tbl_tramite = $("#tabla_tramite").DataTable({
      ...
      buttons:[ 
    {
      ...
      filename: function() {
        return  "LISTA DE DOCUMENTOS POR FECHA Y ESTADO"
      },
        title: function() {
          return  "LISTA DE DOCUMENTOS POR FECHA Y ESTADO" }
...
function listar_estado_busqueda(){
  ...
  tbl_tramite = $("#tabla_tramite").DataTable({
      ...
      "processing": true,
      "ajax":{
          "url":"../controller/tramite/controlador_listar_tramite_fecha_estado.php",
          type:'POST',
          data:{
