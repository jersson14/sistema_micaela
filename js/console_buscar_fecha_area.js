...
function listar_tramite(){
  tbl_tramite = $("#tabla_tramite").DataTable({
      ...
      buttons:[ 
    {
      ...
      filename: function() {
        return  "LISTA DE DOCUMENTOS POR FECHA Y ÁREA"
      },
        title: function() {
          return  "LISTA DE DOCUMENTOS POR FECHA Y ÁREA" }
...
function listar_fechas_busqueda(){
    ...
    let area = document.getElementById('select_area_p').value;
  ...
  tbl_tramite = $("#tabla_tramite").DataTable({
      ...
      "processing": true,
      "ajax":{
          "url":"../controller/tramite/controlador_listar_tramite_fecha_area.php",
          type:'POST',
          data:{
