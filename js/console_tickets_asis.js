...
function listar_nota_salida() {
  ...
  tbl_nota_credito = $("#tabla_nota_credito").DataTable({
    ...
    processing: true,
    ajax: {
      url: "../controller/tickets/controller_listar_tickets_asis.php",
      type: "POST",
       data: {
        ori: ori
        },
...
let ori = document.getElementById("txt_sucursal").value;
  ...
  tbl_nota_credito = $("#tabla_nota_credito").DataTable({
    ...
    processing: true,
    ajax: {
      url: "../controller/tickets/controller_listar_tickets_pordia_asis.php",
      type: "POST",
      data: {
        ori: ori
        },
...
let ori = document.getElementById("txt_sucursal").value;
  ...
  tbl_nota_credito = $("#tabla_nota_credito").DataTable({
    ...
    processing: true,
    ajax: {
      url: "../controller/tickets/controller_listar_tickets_filtro_fechas_asi.php",
      type: "POST",
      data: {
        fechaini: fechaini,
        fechafin: fechafin,
