...
function listar_todas_los_encomiendas_re() {
  ...
  tbl_encomiendas = $("#tabla_encomiendas").DataTable({
    ...
    processing: true,
    ajax: {
      url: "../controller/encomiendas/controlador_listar_todas_encomiendas_re.php",
      type: "POST",
      data: {
        des: des,
      },
    ...
    buttons: [
      {
        ...
        filename: "LISTA DE ENCOMIENDAS RECEPCIÓN",
        title: "LISTA DE ENCOMIENDAS RECEPCIÓN",
    ...
    columns: [
      ...
      // ---- BOTONES PARA RECEPCIÓN DE ENCOMIENDAS ----
      {
        data: null,
        render: function (data, type, row) {
          ...
          // LÓGICA DE BOTONES PARA RECEPCIÓN DE ENCOMIENDAS (DESTINO)
          const reglasRecepcion = {
            // ===== PAGADO =====
            "PAGADO|PENDIENTE": [
              botones.mostrar,
              botones.historial,
          ...
          let acciones = reglasRecepcion[clave] || [botones.mostrar, botones.historial];

          // Dropdown con los botones correspondientes
          return `
...
function listar_encomiendas_por_dia() {
  let des = document.getElementById("txt_sucursal").value;
  ...
  tbl_encomiendas = $("#tabla_encomiendas").DataTable({
    ...
    processing: true,
    ajax: {
      url: "../controller/encomiendas/controlador_listar_encomiendas_por_dia_asis.php",
      type: "POST",
      data: {
        des: des
      },
...
function listar_encomiendas_fecha_estado_re() {
  let des = document.getElementById("txt_sucursal").value;
  ...
  tbl_encomiendas = $("#tabla_encomiendas").DataTable({
    ...
    processing: true,
    ajax: {
      url: "../controller/encomiendas/controlador_listar_encomiendas_fecha_estado_re.php",
      type: "POST",
      data: {
        des: des,
        fedes: fedes,
