                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-6 form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="txt_fecha_creacion">
                        </div>
                          <div class="col-4 form-group">
                        ...
                        <div class="col-4 form-group">
                            ...
                            <input type="text" class="form-control" value="0.00" id="txt_pago_editar" placeholder="Ingrese el monto adelantado" onkeypress="return soloNumeros(event)">
                        </div>
                        <div class="col-12 form-group">
                            <label for="">Observaciones(Opcional):</label>
                            <textarea style="color:red" class="form-control" id="txt_descripcion" rows="2" style="resize:none" placeholder="Ingrese alguna observación o descripción de la reserva"></textarea>
                        </div>
