...
-- Tiempo de generación: 21-09-2025 a las 00:16:41
...
INNER JOIN choferes c      ON s.id_conductor = c.id_chofer
INNER JOIN usuario u       ON s.id_usuario   = u.id_usuario
WHERE NOT s.estado ='ELIMINADO' AND
...
(6, 'DNI', '72646121', 'JERSSON JORGE CORILLA MIRANDA', 'ABANCAY', '985411233', '', '', NULL, NULL, '2025-09-07 11:24:15', '2025-09-20 11:11:22'),
...
(5, '222332', 2, 1, 2, '2025-08-21 09:12:05', 'CAJA PEQUEÑA', 1, 2, 40.00, 0.00, 0.00, 2, NULL, 'PAGADO', '2025-08-21 09:12:31', NULL, 'EN TRANSITO', NULL, NULL, NULL),
(13, 'E-0000002', 2, 1, 2, '2025-09-07 11:37:00', 'SACO PEQUEñO', 13, 14, 25.00, 0.00, 0.00, 2, 'NO ACEPTA EL PRECIO', 'PAGADO', '2025-09-07 11:37:58', NULL, 'EN TRANSITO', NULL, NULL, 2),
...
(22, 'E-0000009', 3, 2, 1, '2025-09-20 15:13:00', 'UN DOCUMENTO EN MANILA', 31, 32, 0.00, 20.00, 0.00, 1, '', 'POR PAGAR', '2025-09-20 15:14:36', NULL, 'PENDIENTE', NULL, NULL, 9);
...
(1, 'S-000001', 2, 3.00, '2025-09-20 15:55:40', 1, 2, '2025-09-20 15:55:46', NULL, 'Salio completo', 1, 'EN TRANSITO', 1, 4, 2),
(3, 'S-000002', 3, 3.00, '2025-09-20 15:59:17', 1, 2, '2025-09-20 15:56:27', NULL, NULL, 1, 'EN TRANSITO', 2, 6, 3),
(4, 'S-000003', 2, 3.00, '2025-09-19 16:46:27', 2, 1, '2025-09-19 16:46:35', NULL, NULL, 2, 'COMPLETADO', 3, 4, 1);
...
--
ALTER TABLE `encomiendas`
  MODIFY `id_encomienda` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `historial_estados`
  MODIFY `id_historial_estado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `salidas_diarias`
  MODIFY `id_salidas_diarias` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `salida_encomienda`
  MODIFY `id_enco_salida` int(11) NOT NULL AUTO_INCREMENT;
